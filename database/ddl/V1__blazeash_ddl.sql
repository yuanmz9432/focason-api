DROP TABLE IF EXISTS `lemonico`.`authority`;
DROP TABLE IF EXISTS `lemonico`.`user`;
DROP TABLE IF EXISTS `lemonico`.`user_authority`;

CREATE TABLE `lemonico`.`authority`  (
...
CREATE TABLE `lemonico`.`user_authority`  (
