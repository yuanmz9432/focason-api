...
public class UpdateRequestExternalModel extends RequestModel implements java.io.Serializable
{
    private UpdateRequestExternalItem[] updateRequestExternalItem;

    public UpdateRequestExternalModel() {}

    public UpdateRequestExternalModel(
        UpdateRequestExternalItem[] updateRequestExternalItem) {
     ...
     */
    public UpdateRequestExternalItem[] getUpdateRequestExternalItem() {
        return updateRequestExternalItem;
    }
     ...
     */
    public void setUpdateRequestExternalItem(UpdateRequestExternalItem[] updateRequestExternalItem) {
        this.updateRequestExternalItem = updateRequestExternalItem;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof UpdateRequestExternalModel))
            return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getUpdateRequestExternalItem() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getUpdateRequestExternalItem()); i++) {
                Object obj = java.lang.reflect.Array.get(getUpdateRequestExternalItem(), i);
                if (obj != null &&
