...
public class UpdateResponseExternalModel extends ResponseModel implements java.io.Serializable
{
    private UpdateResponseExternalItem[] updateResponseExternalItem;
    ...
    public UpdateResponseExternalModel(
        String errCode,
        String errMessage,
        UpdateResponseExternalItem[] updateResponseExternalItem) {
        super(
            errCode,
            errMessage);
     ...
     */
    public UpdateResponseExternalItem[] getUpdateResponseExternalItem() {
        return updateResponseExternalItem;
    }
     ...
     */
    public void setUpdateResponseExternalItem(UpdateResponseExternalItem[] updateResponseExternalItem) {
        this.updateResponseExternalItem = updateResponseExternalItem;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof UpdateResponseExternalModel))
            return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getUpdateResponseExternalItem() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getUpdateResponseExternalItem()); i++) {
                Object obj = java.lang.reflect.Array.get(getUpdateResponseExternalItem(), i);
                if (obj != null &&
