...
import com.lemonico.core.interceptor.PlConditionalMappingHandlerInterceptor;
...
@Configuration
public class PlApiInterceptorAutoConfigurer implements WebMvcConfigurer
{
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new PlConditionalMappingHandlerInterceptor(this.environment));
    }
    ...
    @Autowired
    public PlApiInterceptorAutoConfigurer(final Environment environment,
