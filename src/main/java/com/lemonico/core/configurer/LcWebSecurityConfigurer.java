...
import com.lemonico.auth.config.AuthenticationTokenFilter;
import com.lemonico.core.handler.DefaultAccessDeniedHandler;
import com.lemonico.core.handler.EntryPointUnauthorizedHandler;
...
public class LcWebSecurityConfigurer extends WebSecurityConfigurerAdapter
{
    /**
     * 401
     */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            ...
            // 登录接口放行
            .antMatchers("/api/heartbeat", "/api/auth/**").permitAll()
            // 権限設定
