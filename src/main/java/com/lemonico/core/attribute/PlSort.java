...
public final class PlSort
{
    ...
    public PlSort(final String property, final Direction direction) {
        this.property = property;
        this.direction = direction;
    }

    public static LemonicoSortBuilder builder() {
        return new LemonicoSortBuilder();
    }

    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof PlSort)) {
            return false;
        } else {
            PlSort other = (PlSort) o;
    ...
    public PlSort withProperty(final String property) {
        return Objects.equals(this.property, property) ? this : new PlSort(property, this.direction);
    }

    public PlSort withDirection(final Direction direction) {
        return this.direction == direction ? this : new PlSort(this.property, direction);
    }
    ...
    public static class LemonicoSortBuilder
    {
        ...
        public LemonicoSortBuilder property(final String property) {
            this.property = property;
            return this;
        }

        public LemonicoSortBuilder direction(final Direction direction) {
            this.direction = direction;
            return this;
        }

        public PlSort build() {
            return new PlSort(this.property, this.direction);
        }
