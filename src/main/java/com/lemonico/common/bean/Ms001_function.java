...
/**
 * @className: Ms001_function
 * @description: 機能マスタ
 * @date: 2020/9/25 14:17
 **/
@ApiModel(value = "機能マスタ")
public class Ms001_function implements Serializable
{
    @ApiModelProperty(value = "機能コード", required = true)
    private String function_cd;
    @ApiModelProperty(value = "機能名称", required = true)
