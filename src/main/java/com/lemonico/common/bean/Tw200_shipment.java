...
public class Tw200_shipment
{
    ...
    @ApiModelProperty(value = "NTM-运费")
    private Integer freight;
    @ApiModelProperty(value = "NTM-捆包费")
    ...
    @ApiModelProperty(value = "商品状态 用于标识其详细中是否含有系统不存在的商品")
    private Integer kubun;
    @ApiModelProperty(value = "配送先名前フリガナ")
    private String surname_kana;
    @ApiModelProperty(value = "Qoo10関連注文番号")
    private String related_order_no;
    @ApiModelProperty(value = "")
    private Integer finish_flg;
    ...
    public String getSurname_kana() {
        return surname_kana;
    }

    public void setSurname_kana(String surname_kana) {
        this.surname_kana = surname_kana;
    }

    public Integer getFinish_flg() {
        return finish_flg;
    }

    public void setFinish_flg(Integer finish_flg) {
        this.finish_flg = finish_flg;
    }

    @Override
    public String toString() {
        return "Tw200_shipment{" +
            "client_id='" + client_id + '\'' +
            ...
            ", delivery_tracking_nm='" + delivery_tracking_nm + '\'' +
            ", order_no='" + order_no + '\'' +
            ...
            ", tax_for_cash_on_delivery=" + tax_for_cash_on_delivery +
            ", delivery_method='" + delivery_method + '\'' +
            ", box_delivery=" + box_delivery +
            ", fragile_item=" + fragile_item +
            ", invoice_special_notes='" + invoice_special_notes + '\'' +
            ", instructions_special_notes='" + instructions_special_notes + '\'' +
            ", international=" + international +
            ", delivery_service='" + delivery_service + '\'' +
            ", currency_code='" + currency_code + '\'' +
            ", pdf_name='" + pdf_name + '\'' +
            ", pdf_confirm_img='" + pdf_confirm_img + '\'' +
            ", insurance=" + insurance +
            ", bikou1='" + bikou1 + '\'' +
            ", bikou2='" + bikou2 + '\'' +
            ", bikou3='" + bikou3 + '\'' +
            ...
            ", upd_date=" + upd_date +
            ", del_flg=" + del_flg +
            ", tw201_shipment_detail=" + tw201_shipment_detail +
            ", client_nm='" + client_nm + '\'' +
            ", size_cd='" + size_cd + '\'' +
            ", ms012_sponsor_master=" + ms012_sponsor_master +
            ", size_name='" + size_name + '\'' +
            ", tnnm='" + tnnm + '\'' +
            ...
            ", delivery_code_csv='" + delivery_code_csv + '\'' +
            ", delivery_tracking_nm_list=" + delivery_tracking_nm_list +
            ", fileName='" + fileName + '\'' +
            ", delivery_id='" + delivery_id + '\'' +
            ", outer_order_no='" + outer_order_no + '\'' +
            ", payment_method='" + payment_method + '\'' +
            ", cancelFlg=" + cancelFlg +
            ", photography_flg=" + photography_flg +
            ...
            ", memo='" + memo + '\'' +
            ", subtotal_amount_tax=" + subtotal_amount_tax +
