package com.blazeash.api.cloud.service;



import com.blazeash.api.core.attribute.BaErrorCode;
import com.blazeash.api.core.exception.BaException;
import java.net.URL;
...
public class S3Service
{
    ...
    public boolean doesObjectExist(String objectKey) {
        ...
        try {
            ...
            throw new BaException(BaErrorCode.INTERNAL_SERVER_ERROR, e.getMessage());
        }
        return true;
    }
